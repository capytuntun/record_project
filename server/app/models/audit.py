...
# Decrypted recording segments left the system as a downloadable file. Kept
# distinct from VIEW_RECORDING because a copy outside the encrypted store is a
# bigger event than a replay in the console.
